...
representing a fluctuating environment. Based on the litterature and previous
...
structure on stability, we partionned asynchrony into statistical averaging
effect (SAE) and compensatory dynamics effect (CPE) [@zhao_biodiversity_2022].
SAE quantities the portfolio effect emerging from independant species
...
enviromental stochasticity was assumed to be mainly associated to population
...
average interaction strength, as well as enviromental stochasticity and species
...
because its strong total positive effect on asynchony (`r rtar`) was downplayed
by its total negative effect on population stability (`r rtpr`) and that the
weigtht of population stability on community stability is twice higher than the
one of asynchony. Average trophic level, type III functional response and
...
to a less dramatic fluctuations of prey biomass [@uszko_effects_2017;
