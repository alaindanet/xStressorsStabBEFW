...
- Email address:
  - Alain Danet (corresponding author): a.h.danet@sheffield.ac.uk
...
- Number of words: Abstract: 150, Main text: 4843
...
- Number of references: 61, Number of figures: 2, Number of tables: 0
...
- Corresponding author: Alain Danet, School of Biosciences, Ecology and
  ...
  2TN, UK; e-mail address: a.h.danet@sheffield.ac.uk

Following Ecology Letters offering for initial submission, we submit the
manuscript in the format of the journal *Nature Ecology & Evolution*.

Statement of authorship: AD and APB designed the research, AD performed the
research. AD wrote the first draft of the manuscript. All authors all authors
contributed substantially to revisions.

Data accessibility statement: The code used to run the simulations, analyse them
and to write the manuscript is available on Github (https://github.com/alaindanet/xStressorsStabBEFW) and
archived on Zenodo: https://doi.org/10.5281/zenodo.13454946.
...
response diversity and stochasticity. Using a stochastic bioenergenetic food-web
model, we reveal that response diversity is a major driver of community
stability. Moreover, positive stability-richness relationships emerge only in
the presence of response diversity. In contrast to previous work, food-web
structure is only secondary driver of community stability, but interact with
response diversity to determine the sign of the stability-richness relationship.
Our study highlights the complex pathways by which food-web structure and
response diversity drive community stability, and raises concerns about how the
loss of response diversity may lead to a breakdown of community stability.
...
---
#The Question is: How do ecological communities respond to perturbations?
#1) Biodiversity-Stability super interesting: empirical and theory shows that
#temporal stability increases with species richness in competitive communities,
#but also in bi-trophic (plant-herbivores) communities [@downing_ecosystem_2002;
#@srednick_understanding_2024; @thebault_stability_2010]. Because response
#diversity that
#2) But another body of theory demonstrated that community structure, in
#particular, food-web structure could impair or enhance temporal community
#stability.
#3) Species-rich communities contain more trophic levels than species-poor
#communities [@galiana_spatial_2018], and previous empirical and theoretical
#research showed that species richness and food-web structure both drive temporal
#stablity [@danet_species_2021; @eschenbrenner_diversity_2023], and empirical
#findings that species richness can decrease community stability in fish
#food-webs [@danet_species_2021].
#4) However, the mechanisms by which species richness and food-web structure both
#adds and interact to drive temporal stability of complex food-web communities and
#diversity-stability relationships has still been overlooked.
#5) In what follows, we review those mechanisms, i.e. the role of species
#response diversity to perturbations [@yachi_biodiversity_1999;
#@ives_stability_2000; @elmqvist_response_2003; @ives_stability_2000] which gives
#rise to positive stability-diversity relationships, the role of trophic structure and
#interaction strengths [@may_will_1972; @angelis_stability_1975;
#@mccann_weak_1998; @mccann_reevaluating_1997; @thebault_trophic_2005;
#@thebault_relationship_2006; @thebault_stability_2010] which can impair or
#enhance temporal stabilty, and the pathways by which they affect temporal
#stability, i.e average population stability, asynchrony and portfolio effects
#[@thibaut_understanding_2013; @zhao_biodiversity_2022]. Here, we present a study
#that integrates those three bodies to advance our understanding of when and how
#species richness and food-web structure is expected to impair or enhance the
#stability of ecological communities to perturbations.
---

Global change, characterised by multiple, simultaneous threats to biodiversity
[@lee_ipcc_2023; @simmons_refocusing_2021], is having impacts on the temporal
stability of complex ecological communities [@olivier_urbanization_2020;
...
these communities to deliver functions and services to human societies
[@loreau_ecological_2022]. Understanding and predicting the temporal stability
of ecological communities requires the integration multiple concepts and
theories about temporal stability in species diverse and structurally complex
communities. These include classic ideas about the role of trophic structure and
interaction strengths [@may_will_1972; @angelis_stability_1975;
@mccann_weak_1998; @mccann_reevaluating_1997; @thebault_trophic_2005;
@thebault_relationship_2006; @thebault_stability_2010], the role of species
response diversity to perturbations [@yachi_biodiversity_1999;
@ives_stability_2000; @elmqvist_response_2003], the role of temporal stability
components [@thibaut_understanding_2013; @zhao_biodiversity_2022] (i.e. average
population stability, asynchrony and portfolio effects), and integrative
theories about the relationship between stability, structure and diversity.
...
affect to population stability (i.e. by increasing amplitude of population
