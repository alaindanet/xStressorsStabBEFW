...
- Putative titles:
  ...
  - Response diversity and food-web structure drive stability and
    stability-richness relationships in fluctuating environments
...
The diversity of species responses to environmental stochasticity is key to
understand temporal community stability and stability-diversity relationships.
While we know quite well how response diversity and species richness drive
community stability in plant communities, whether these effects also operate
in complex food-webs remains an open question. Using a stochastic Bioenergenetic
model, we show that response diversity and species richness are also strong drivers
of overall community stability in complex food-webs. In contrast, we found that
interaction strength and connectance had little effects on temporal stability
overall. Negative stability-richness relationships always emerged in the absence
of response diversity, but we found that interaction strength, connectance,
average trophic level strongly interact with response diversity to determine the
sign of stability-diversity relationships. Our study disentangles the complex
effects of food-web structure on community stability and its pathway, showing
that response diversity is a mechanism that generate positive
stability-diversity relationships, beyond plant communities.

# Introduction

Predicting how ecological communities respond ever-growing anthropogenic
pressures is a central focus in Ecology [@newbold_global_2015;
@services_summary_2019]. Most approaches so-far involve static environment and
simplified species assemblages, overlooking environmental stochasticity and the
complex structure of ecological communities. However, the effects of
stochasticity is much more than noise and lead to emerging properties at the
community level. The key mechanism is the way that species respond to
environmental stochasticity, the so called response diversity
[@elmqvist_response_2003; @loreau_species_2008; @ives_stability_2000;
@ross_how_2023]. Response diversity, even considered as pure random species
fluctuations, generate asynchrony in species fluctuations at the community
level. Coined as "statistical averaging", "portfolio effects" or "insurance
hypothesis", it is responsible for the positive relationships between temporal
stability of community and species richness in plant communities
[@doak_statistical_1998; @yachi_biodiversity_1999; @tilman_biodiversity_2006;
@zhao_biodiversity_2022]. But species responses to environmental fluctuations is
also constrained by species interactions, and so community structure
[@loreau_species_2008; @vasseur_environmental_2007; @thebault_trophic_2005;
@thebault_relationship_2006]. A pioneer example by @vasseur_environmental_2007,
in which they present a counter-intuitive example, where the lack of response
diversity can dampen species oscillations and then increase the temporal
stability in a four species diamond food-web [@mccann_weak_1998]. Despite its
overarching importance on community stability and stability-richness
relationships, the effects of stochasticity and response diversity in complex
communities, such as food-webs, remain mostly unknown.
...
can be partitioned into average population stability and asynchrony
[@thibaut_understanding_2013; @zhao_biodiversity_2022], which respectively
measures the amplitude of species fluctuations relative to their
biomass/abundance and how much species fluctuations’ are compensating each other
at the community level. Asynchrony can then stem from statistical averaging of
independent species fluctuations ["portfolio effects", @doak_statistical_1998;
@tilman_ecological_1999] or compensatory dynamics resulting from response
diversity to environmental fluctuations and species interactions
[@zhao_biodiversity_2022]. The body of theory of BEF, focusing mainly on plants,
showed that response diversity and species richness give rise to asynchrony and
thereby increase community stability, despite that species richness can decrease
population stability in the same time [@tilman_biodiversity_2006;
@houlahan_negative_2018]. On the other side, food-web theory focused more on
population stability. It shows that the strength [@may_will_1972;
@mccann_weak_1998; @thebault_trophic_2005] and distribution [@may_will_1972;
@angelis_stability_1975; @mccann_weak_1998; @mccann_reevaluating_1997] of
species interactions determine population stability ("complexity-stability"
theory) and stability-richness relationship [two trophic level systems,
@thebault_trophic_2005; @ives_stability_2007], while the number of trophic
levels determine population stability [@shanafelt_stability_2018]. Food-web
structure also interacts with response diversity to determine population
stability in diamond shaped food-webs [@ripa_food_2003;
@vasseur_environmental_2007; @ruokolainen_environmental_2013]. So far, food-web
theory overlooked the effects of food-web structure on response diversity and
asynchrony while BEF theory overlooked the complex effects of food-web structure
on population stability and asynchrony. Two keys advances allow to overcome that
limitation: the development of the Bioenergenetic model that enable to model
arbitrary complex communities [@yodzis_body_1992; @brose_allometric_2006] and
the development of statistical tools that enables to partition community
stability into population stability and asynchrony [@thibaut_understanding_2013;
...
from portfolio and compensatory effects. As expected the mathematical
relationship (eq. \@ref(eq:sae-even)), species richness was a main positive
driver of portfolio effects ($r_\delta$= `r rsr`, Fig. \@ref(fig:sem)a), thereby
increasing asynchrony. In turn, species richness, average trophic level and
connectance had negative effects on the evenness of species variability (resp.
$r_\delta$= `r rer`, `r ret`, and `r rect`), thereby downplaying the portfolio
effect raised from species richness alone in a scenario of even species
variabilities. In turn, we found that response diversity had a positive effect
on evenness of species variability ($r_\delta$=`r red`), thereby maximising the
portfolio effect. We found that species response diversity had a strong positive
effect on compensatory dynamics ($r_\delta$= `r rcd`), while average interaction
strength had a small positive effect ($r_\delta$= `r rci`, Fig. \@ref(fig:sem)).
