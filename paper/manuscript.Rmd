...
Empirical and theoretical evidence suggests environmental changes will
...
and the compensatory dynamics effects [@zhao_biodiversity_2022]. Portfolio
effects stem from the statistical averaging of independent population
fluctuations [@doak_statistical_1998; @zhao_biodiversity_2022], thereby
increasing asynchrony. Compensatory dynamics in turn capture population
fluctuations that are more synchronous or asynchronous than expected for
independent fluctuations, and can stem from species interactions and species
responses to perturbations [@zhao_biodiversity_2022]. This allows an
unprecedented opportunity to obtain mechanistic insight about the effects of
stressors and food-web structure on stability in complex, species rich
communities.
