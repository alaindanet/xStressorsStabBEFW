...
map_tibble <- tibble::tibble(
  names = c("no_rerun", "non_allo_no_rerun", "rerun", "no_rerun_short",
...
```{targets raw_sim}
list(
  tar_target(sim_fw, sim_fw_rerun),
  ...
  tar_target(sem_simplified_tot,
    tibble(
      ...
      eff = list(
        ...
        sem_simplified_eff_tab_no_rerun_short,
        sem_simplified_eff_tab_no_rerun_no_disconnected
        ),
      rsq = list(
        sem_simplified_rsquared_no_rerun,
        sem_simplified_rsquared_non_allo_no_rerun,
        sem_simplified_rsquared_rerun,
        sem_simplified_rsquared_no_rerun_short,
        sem_simplified_rsquared_no_rerun_no_disconnected
        ),
      collinearity = list(
        sem_simplified_collinearity_no_rerun,
        sem_simplified_collinearity_non_allo_no_rerun,
        sem_simplified_collinearity_rerun,
        sem_simplified_collinearity_no_rerun_short,
        sem_simplified_collinearity_no_rerun_no_disconnected
        ),
    )
  ),
...
list(
  ...
  tar_target(sem_main_text_model_list,
    list(
  ...
  tar_target(sem_main_text, {
    ti <- as.psem(sem_main_text_model_list)
    #update(ti, avg_omnivory %~~% w_avg_tlvl)
    }
    ),
  ...
  tar_target(sem_simplified_eff_tab, sem_simplified_eff_tab_no_rerun)
)
```
...
list(
  ...
  tar_target(fixed_effect_fw_stab, fixef(model_fw_stab)$cond),
...
```{r, eval=FALSE}
tar_load(sem_simplified_eff_tab_no_rerun_short)
sem_simplified_eff_tab_rerun %>%
  filter(
    effect_type == "direct",
    predictor %in% c(sem_tot_predictor(), "async", "stab_com", "sae_total", "cpe", "evenness_sae", "sae_even")
    ) %>%
