...
The question at 1bn pound is "what is driving stability?", i.e. the propagation
...
interactions. The tremendous early work of McCann and other authors about the
distribution of interaction strength is really interesting, showing that
coupling weak interactions to strong one stabilize food-web dynamics.
...
mass ratios (Z) such as Z increases the metabolism of predators decreases
relative to prey (i.e. $x_i$ and $y_i$). Thus increasing Z decreases $I_{ki}$.
The main difference between Brose and McCann approaches is that the Brose
