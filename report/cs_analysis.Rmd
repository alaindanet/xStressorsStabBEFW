...
Global change and their effects constitute major treats to ecosystem stability.
Among them, global change is predicted to lead dramatically more variable
environments [@pachauri_climate_2015]. This new threat adds to current
eutrophication in many ecosystems [@maure_globally_2021, add ref], which is
known to dramatically impair ecosystem functioning. Understanding how
environmental variability and eutrophication will alter ecosystem stability is
then a timely question.
...
affects the relationships between species richness and temporal stability.
