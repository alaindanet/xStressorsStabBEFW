#!/bin/bash
#
#SBATCH --job-name=allo_d_no_rerun_no_disconnected
...
cd ${DIR_ENV} && ${JULIA} --project=${DIR_ENV} ${DIR_ENV}/${DIR_SCRIPT}/ct_S_h_d_allometric_array_no_rerun_no_disconnected.jl ${START} ${END}
